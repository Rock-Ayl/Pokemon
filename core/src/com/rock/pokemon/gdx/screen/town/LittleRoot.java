...
public class LittleRoot implements Screen {
    ...
    public LittleRoot(final Pokemon pokemon) {
        ...
        //一个普通NPC加入到该世界
        new Person(PersonEnum.PROF_BIRCH, this.world, 14, 18, this.game.getAssetManager(), this.game.getSoundManager(), true);
        ...
        //初始化主角
        this.adventurer = new Person(PersonEnum.RUBE, this.world, 19, 18, this.game.getAssetManager(), this.game.getSoundManager(), false);
